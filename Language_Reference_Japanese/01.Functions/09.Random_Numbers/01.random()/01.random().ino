...
// on subsequent executions of a sketch, use randomSeed() to initialize the random number generator 
...
// Setting max to a higher value won’t generate an error during compilation, 
// but during sketch execution the numbers generated will not be as expected.
