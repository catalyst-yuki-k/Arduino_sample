...
// or you can make a string out of an array of type char and null-terminate it. 
// This page described the latter method. For more details on the String object, 
// which gives you more functionality at the cost of more memory, see the String object page.
// 
// Syntax
...
// (e.g. if you had specified the length of Str2 as seven instead of eight). 
// This will break most functions that use strings, so you shouldn’t do it intentionally. 
// If you notice something behaving strangely (operating on characters not in the string), 
...
// but it isn’t necessary to understand pointers in detail to use them effectively here.
