...
// 
// Example Code
// The sizeof operator is useful for dealing with arrays (such as strings) 
// where it is convenient to be able to change the size of the array without breaking other parts of the program.
// 
