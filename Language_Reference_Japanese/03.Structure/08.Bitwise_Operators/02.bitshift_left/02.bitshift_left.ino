...
// If you are certain that none of the ones in a value are being shifted into oblivion, 
// a simple way to think of the left-shift operator is that it multiplies the left operand by 2 raised to the right operand power. 
...
//     1 << 10   1024
//     ...
// The following example can be used to print out the value of a received byte to the serial monitor, 
// using the left shift operator to move along the byte from bottom(LSB) to top (MSB), and print out its Binary value:
