...
// Bitwise AND operates on each bit position of the surrounding expressions independently, according to this rule: 
...
// and all 16 resulting bits are stored in c, 
