...
// Unlike & and |, the bitwise NOT operator is applied to a single operand to its right. 
...
// This is because the highest bit in an int variable is the so-called sign bit. 
// If the highest bit is 1, the number is interpreted as negative. 
// This encoding of positive and negative numbers is referred to as two’s complement. 
// For more information, see the Wikipedia article on two’s complement.
// 
