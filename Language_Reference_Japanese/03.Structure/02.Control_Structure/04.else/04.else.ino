...
// When a true test is found, its associated block of code is run, 
// and the program then skips to the line following the entire if/else construction. 
// If no test proves to be true, the default else block is executed, 
// if one is present, and sets the default behavior.
// 
