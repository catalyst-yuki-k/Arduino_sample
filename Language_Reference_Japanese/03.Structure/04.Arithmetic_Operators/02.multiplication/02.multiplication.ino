// Description
// Multiplication is one of the four primary arithmetic operations. 
// The operator * (asterisk) operates on two operands to produce the product.
// 
// Syntax
...
// 3.If the operands are of float / double data type and the variable that stores the product is an integer, 
