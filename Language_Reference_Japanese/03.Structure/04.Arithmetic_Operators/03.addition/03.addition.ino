// Description
// Addition is one of the four primary arithmetic operations. 
...
// Notes and Warnings
// 1.The addition operation can overflow 
//   if the result is larger than that which can be stored in the data type 
//   (e.g. adding 1 to an integer with the value 32,767 gives -32,768).
...
// 3.If the operands are of float / double data type and the variable that stores the sum is an integer, 
